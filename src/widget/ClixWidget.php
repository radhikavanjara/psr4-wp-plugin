 ...
 */
 ...
 class ClixWidget {
	...
	public function enqueueStyles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'src/widget/css/ClixPublic.css', array(), $this->version, 'all' );
	...
	public function enqueueScripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'src/widget/js/ClixPublic.js', array( 'jquery' ), $this->version, false );
